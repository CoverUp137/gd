...
# 自用BOT
* [x] 新TG使用了新的登陆机制，手机号无法收到短信，原BOT登陆会提示 RPCError 406，现已修复
* [x] 增加CC大佬的部分插件
* [x] 去除原版的WALI解析，新增自建sign解析，需要把自建sign放在变量里面，具体看脚本提示，使用方法跟原来的jx一样
* [x] 增加京东历史价格脚本，对机器人发送京东商品链接
* [x] 新增时间脚本，发送date，机器人全局回复当前时间
